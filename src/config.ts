...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://0721255.xyz/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-07-03", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "957824", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
...
export const footerConfig: FooterConfig = {
	...
	customHtml: `<a href="https://beian.miit.gov.cn/" target="_blank" rel="noopener noreferrer" style="font-size: 12px; color: #666;">
      粤ICP备XXXXXXX号-X
    </a>`, // HTML格式的自定义页脚信息，例如备案号等，默认留空
